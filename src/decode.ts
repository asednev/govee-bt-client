...
export const decodeH5074Values = (streamUpdate: string) => {
    ...
    const temp_lsb = streamUpdate.substring(8, 10).concat(streamUpdate.substring(6, 8));
    const hum_lsb = streamUpdate.substring(12, 14).concat(streamUpdate.substring(10, 12));
